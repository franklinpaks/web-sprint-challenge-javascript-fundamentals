...
// The nestedFunction function can access internal because it is a function that is initialized inside a bigger function, myFunction, in which the internal constant is also initialized.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
    const lowerAnimals = zooAnimals.map(item => 
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const lessAnimals = zooAnimals.filter(item => {
